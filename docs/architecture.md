...
| プラン | 月額 | 1人あたり(15人) | 対象 | 含まれる機能 |
|-------|------|---------------|------|------------|
| **Free** | ¥0 | ¥0 | 全チーム | 出欠管理、手動マッチング、精算計算、基本通知 |
| **Pro** | ¥1,000 | ¥67 | 管理を効率化したいチーム | Free + メンバー管理強化、個人成績・出席率分析、メンバー区分管理、グラウンド自動監視、段階的リマインド自動化 |
| **AI** | ¥1,500 | ¥100 | AI提案が欲しいチーム | Pro + 出席予測、助っ人推薦、打診文面自動生成、対戦マッチング提案、週次レポート生成 |
| **Auto** | ¥5,000 | ¥333 | 代表の仕事をゼロにしたいチーム | AI + 完全自動運営（試合作成→出欠→リマインド→助っ人手配→マッチング→精算を全自動。異常時のみ通知） |
...
Auto プランが売るものは**「代表という役職を消す」**こと。

20年チームを回してきた代表が「もう辞めたい」と思ってるチームは山ほどある。
代わりにシステムが全自動で回すなら、月¥5,000（1人¥333）は安い。

```
Auto プランの自動化範囲:

  毎週月曜:
    ✅ 次の試合を自動作成（活動曜日+ホームグラウンドから）
    ✅ 出欠通知を自動送信
  
  火〜木:
    ✅ 24h/48h/72h リマインドを自動送信
    ✅ 未回答→不参加を自動処理
...
| 項目 | 原価 |
|------|------|
| AI API（AI プランと同等） | ¥30/チーム/月 |
| 自動実行 Cron 追加コスト | ≒¥0（インフラ費に含まれる） |
| **合計** | **¥30/チーム/月** |

```
Auto プラン売上: ¥5,000/チーム/月
原価:            ¥30/チーム/月
→ 粗利:          ¥4,970/チーム/月（粗利率 99.4%）
```

### 8.6 収益シミュレーション

**前提: Free 75% / Pro 13% / AI 7% / Auto 5%**

| 総チーム数 | Free | Pro | AI | Auto | 月間売上 | インフラ費 | API費 | 月間利益 |
|-----------|------|-----|-----|------|---------|-----------|-------|---------|
| 100 | 75 | 13 | 7 | 5 | ¥48,500 | ¥0 | ¥360 | ¥48,140 |
| 1,000 | 750 | 130 | 70 | 50 | ¥485,000 | ¥31,000 | ¥3,600 | ¥450,400 |
| 10,000 | 7,500 | 1,300 | 700 | 500 | ¥4,850,000 | ¥58,000 | ¥36,000 | ¥4,756,000 |
| 100,000 | 75,000 | 13,000 | 7,000 | 5,000 | ¥48,500,000 | ¥378,000 | ¥360,000 | ¥47,762,000 |

**年間:**

| 総チーム数 | 年間売上 | 年間利益 | 利益率 |
|-----------|---------|---------|--------|
| 1,000 | ¥5,820,000 | ¥5,404,800 | 93% |
| 10,000 | ¥58,200,000 | ¥57,072,000 | 98% |
| 100,000 | ¥582,000,000 | ¥573,144,000 | 98% |
...
| Phase 4 | Auto プラン追加。完全自動運営ループ実装 |
| Phase 5 | 年額プラン（2ヶ月分割引）、チーム連盟プラン |
