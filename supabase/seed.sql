...
INSERT INTO helpers (id, team_id, name, note, times_helped) VALUES
  ('ff000000-0001-4001-8001-ff0000000001', '11111111-1111-4111-8111-111111111111', '外山助太', '佐藤さんの友人', 3);

-- 対戦相手チーム
INSERT INTO opponent_teams (id, team_id, name, area, contact_name) VALUES
  ('cccccccc-0001-4001-8001-cccccccccccc', '11111111-1111-4111-8111-111111111111', 'レッドソックス', '東京都・目黒区', '山本監督'),
  ('cccccccc-0002-4002-8002-cccccccccccc', '11111111-1111-4111-8111-111111111111', 'ブルージェイズ', '東京都・渋谷区', '伊藤キャプテン'),
  ('cccccccc-0003-4003-8003-cccccccccccc', '11111111-1111-4111-8111-111111111111', 'イーグルス',     '東京都・新宿区', '木村代表');
...
INSERT INTO games (id, team_id, title, game_type, status, game_date, start_time, end_time, ground_id, ground_name, opponent_team_id, min_players, rsvp_deadline) VALUES
  ('bbbbbbbb-0001-4001-8001-bbbbbbbbbbbb', '11111111-1111-4111-8111-111111111111', '5月第2週 練習試合', 'FRIENDLY', 'COLLECTING', '2026-05-10', '09:00', '12:00', 'eeeeeeee-0001-4001-8001-eeeeeeeeeeee', '世田谷区立総合運動場', 'cccccccc-0002-4002-8002-cccccccccccc', 9, '2026-05-07 23:59:00+09'),
  ('bbbbbbbb-0002-4002-8002-bbbbbbbbbbbb', '11111111-1111-4111-8111-111111111111', '5月第3週 対戦希望', 'FRIENDLY', 'DRAFT',      '2026-05-17', '13:00', '17:00', NULL,                                   NULL,                   NULL,                                   9, NULL),
  ('bbbbbbbb-0003-4003-8003-bbbbbbbbbbbb', '11111111-1111-4111-8111-111111111111', '4月 確定済み試合',  'FRIENDLY', 'CONFIRMED',  '2026-04-12', '09:00', '12:00', 'eeeeeeee-0002-4002-8002-eeeeeeeeeeee', '砧公園野球場',         'cccccccc-0001-4001-8001-cccccccccccc', 9, '2026-04-09 23:59:00+09');

-- 出欠（5月第2週 練習試合向け）
INSERT INTO rsvps (game_id, member_id, response, responded_at) VALUES
  ('bbbbbbbb-0001-4001-8001-bbbbbbbbbbbb', 'aaaaaaaa-0001-4001-8001-aaaaaaaaaaaa', 'AVAILABLE',   now()),
  ('bbbbbbbb-0001-4001-8001-bbbbbbbbbbbb', 'aaaaaaaa-0002-4002-8002-aaaaaaaaaaaa', 'AVAILABLE',   now()),
  ('bbbbbbbb-0001-4001-8001-bbbbbbbbbbbb', 'aaaaaaaa-0003-4003-8003-aaaaaaaaaaaa', 'MAYBE',       now()),
  ('bbbbbbbb-0001-4001-8001-bbbbbbbbbbbb', 'aaaaaaaa-0004-4004-8004-aaaaaaaaaaaa', 'UNAVAILABLE', now()),
  ('bbbbbbbb-0001-4001-8001-bbbbbbbbbbbb', 'aaaaaaaa-0005-4005-8005-aaaaaaaaaaaa', 'NO_RESPONSE', NULL),
  ('bbbbbbbb-0001-4001-8001-bbbbbbbbbbbb', 'aaaaaaaa-0006-4006-8006-aaaaaaaaaaaa', 'AVAILABLE',   now()),
  ('bbbbbbbb-0001-4001-8001-bbbbbbbbbbbb', 'aaaaaaaa-0007-4007-8007-aaaaaaaaaaaa', 'NO_RESPONSE', NULL),
  ('bbbbbbbb-0001-4001-8001-bbbbbbbbbbbb', 'aaaaaaaa-0008-4008-8008-aaaaaaaaaaaa', 'AVAILABLE',   now()),
  ('bbbbbbbb-0001-4001-8001-bbbbbbbbbbbb', 'aaaaaaaa-0009-4009-8009-aaaaaaaaaaaa', 'NO_RESPONSE', NULL);

-- 交渉
INSERT INTO negotiations (id, game_id, opponent_team_id, status, proposed_dates_json, message_sent, reply_received) VALUES
  ('dddddddd-0001-4001-8001-dddddddddddd', 'bbbbbbbb-0001-4001-8001-bbbbbbbbbbbb', 'cccccccc-0002-4002-8002-cccccccccccc', 'ACCEPTED', '["2026-05-10"]', '5月10日に練習試合のお誘いです。', '承知しました！10日午前でお願いします。');
